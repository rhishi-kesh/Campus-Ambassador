...
<body>
	<header>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark" data-bs-theme="dark">
		  <div class="container">
		    <a class="navbar-brand" href="university.php">
				...
				<div class="col-12 col-lg-10">
					<form method="POST" id="contact_form" name="contact_form" enctype="multipart/form-data">
						<div class="row">
							...
							<div class="col-12 col-lg-6">
								<div class="mt-3 mb-3">
								  <label for="number" class="text-white">Name of your University *</label>
							...
							<div class="col-12 col-lg-6">
								<div class="mt-3 mb-3">
								  <label for="cv" class="text-white">Resume/CV</label>
								  <input type="file" accept=".pdf" class="form-control shadow-none" id="cv" required name="cv">
								</div>
							</div>
							<div class="col-12">
								<div class="mt-3 mb-3">
							...
							<div class="col-12">
								<input type="submit" name="submit" class="custom-btn submit-btn shadow-none border-0" value="SUBMIT">
